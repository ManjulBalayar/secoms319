  ...
  <div className="row ">
    <div className="col-3" >
      <button
        ...
        id="back-button"
        className="my-4 bg-green-600 hover:bg-green-700 py-2 px-2 border-green-700 rounded text-green-500"
      >
        Continue Shopping
      </button>
          ...
          <div className="col-8" >
            ...
            <div className="card collapse" style={{ borderColor: "black",borderWidth: "2px", width: "25rem" }}>
              ...
              <button style={{ backgroundColor: "green" }}
                href=""
                onClick={() => {
                  resetCart("Air Janardhans");
                  resetCart("CarHeart 500's");
                  resetCart("Air Nasik");
                  resetCart("IceCream Vans");
                  resetCart("OrangeYouGlad 200");
                  resetCart("Asli Balance 550");
                  resetCart("Sparks Library");
                  resetCart("No Balance 650");
                  changePage("Browse");
                }}
